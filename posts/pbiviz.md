...
-   the dataframe `Values` is the dataset which will be sent to this R
    script by **Power BI**;
...
Firstly, we change the display name of the **Values** dataset. Open the
...
In fact, **pbiviz** is not restricted to render a `htmlwidget`. One can
