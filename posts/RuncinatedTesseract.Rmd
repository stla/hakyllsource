...
The *runcinated tesseract* is a 4D polytope. Thanks to the **cxhull** package, 
I extracted all the tetrahedral cells from it, I rounded them and I plotted 
them with a 4D rotation and a stereographic projection. I really like the 
result. 
