...
**Node.js** is available in the GSK software center. You can alternatively download a portable version on the [nodejs.org](https://nodejs.org/en/download/) website: choose the 64-bit zip, unzip it in a folder and set this folder in your Windows path. 
