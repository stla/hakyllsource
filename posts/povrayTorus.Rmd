...
It is easy to draw a torus with POV-Ray. What we propose here, is to draw a 
torus such that its equator passes by three given points.

The include file [analytical_g.inc](http://www.f-lohmueller.de/pov_tut/a_geo/a_geo70e.htm) made by Friedrich A. Lohmueller provides a macro which does this task, 
namely the macro `Circle_Line_out`. 
However I tested it and I noticed that the rendering is very slow. 
With the macro I wrote, provided below, the rendering is not slow.
...
Let me give an example now. I take a tetrahedron and I draw the torus passing by 
the three vertices of a face, for each of the four faces.
