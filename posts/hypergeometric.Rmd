...
- Converting a `bigq` rational number to a decimal number with `as.numeric` is not a good idea. 
It is better to use the `mpfr` function of the `Rmpfr` package, or the `q2d` function of the package `rcdd`:
