...
knitr::opts_chunk$set(echo = TRUE, collapse=TRUE, 
                      fig.path="./figures/dyadic-", fig.align="center")
...
except when $d=000\ldots$ or when $d$ has the form $d=0^i111\ldots$ ($i\geq 0$). Such a $d$ has the form $d= 0^m1^k10x$ where $m,k \geq 0$ and $x \in {\{0,1\}}^{\mathbb{N}}$, and then the image of $d$ by the Pascal transformation is defined by 
$$
