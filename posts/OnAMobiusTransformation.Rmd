...
Unfortunately, the diameter of the circle is not constant. That is probably 
because I use the disk $\{|z| \leqslant 0.995\}$ instead of the unit disk. 
It is possible to trim the images with the help of **ImageMagick**:
