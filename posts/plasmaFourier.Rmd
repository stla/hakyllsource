...
```{r fig1, fig.width=5, fig.height=5, fig.align='center'}
img <- fplasma1()
...
```{r fourfigs, fig.width=7, fig.height=7, fig.align='center', echo=FALSE}
img1 <- fplasma1()
img2 <- fplasma1()
img3 <- fplasma1()
img4 <- fplasma1()
...
```{r camouflage, fig.width=5, fig.height=5, fig.align='center', echo=FALSE}
opar <- par(mar = c(0, 0, 0, 0))
plot(
  NULL, xlim = c(0, 1), ylim = c(0, 1), asp = 1, 
  xlab = NA, ylab = NA, axes = FALSE, xaxs = "i", yaxs = "i"
