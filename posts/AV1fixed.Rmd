...
$$
Not all vectors of $\mathbb{R}^I\otimes\mathbb{R}^J$ can be written $x \otimes y$, but the vectors $x \otimes y$ span $\mathbb{R}^I\otimes\mathbb{R}^J$. In consistence with this notation, the tensor product $U \otimes V$ of two vector spaces $U \subset R^I$ and $V \subset R^J$ is defined as the vector space spanned by the vectors of the form $x \otimes y$, $x \in U$, $y \in V$. 
