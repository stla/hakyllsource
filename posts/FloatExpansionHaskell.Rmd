...
```{haskell, engine='haskell', engine.path='ghc'}
...
Nowadays, there is a more convenient way to generate a Haskell DLL. I'm using 
*stack* now, and here is the contents of my *stack* project:
