...
The [elliptic Dupin cyclide](https://en.wikipedia.org/wiki/Dupin_cyclide) 
is a generalization of the torus. It has three nonnegative 
parameters $c < \mu < a$, and its usual parameterization is, letting 
$b = \sqrt{a^2 - c^2}$:
$$
...
[this post](https://laustep.github.io/stlahblog/posts/plotly_trisurf.html)):

![](./figures/cyclide_parametric_colored.png)

I think almost everything you can do with a torus, you can do it with a cyclide. 
For example, a parameterization of the $(p,q)$-torus knot is 
$$
...
[this website](https://www.frassek.org/), and then I adapted it to the cyclide.
