...
draw.circle(I[1], I[2], sqrt(k), lwd = 2, border = "red")
# check
...
I2 <- circ1$center + a/(1+a) * (circ2$center - circ1$center)
k2 <- a * abs(c(crossprod(I2-circ2$center) - circ2$radius^2))
iota2 <- Inversion$new(I2, k2)
iota2$invertCircle(circ1)
```
...
(the unique mid-circle). 

This inversion has pole 
$I = O_1 - \frac{\rho}{1-\rho} * (O_2-O_1)$, and power 
$k = \rho|IO_2^2 - r_2^2|$. 
