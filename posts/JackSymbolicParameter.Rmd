...
This is a `symbolicQspray` object. Note that the **symbolicQspray** 
...
*fractions of polynomials with rational coefficients*. I do not consider 
...
the dependence being described by a fraction of polynomials. Thus, the 
...
In fact, from the definition of the Jack polynomials, the coefficients of 
...
A `ratioOfQsprays` object is nothing but a pair of `qspray` objects, the 
...
objects `ratioOfQsprays` represent fractions of *multivariate* polynomial. 
...
But these polynomials are symmetric, so you can have a considerably shorter 
