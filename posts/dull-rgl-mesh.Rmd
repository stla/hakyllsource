...
The visualization of a **rgl** mesh is rather shiny by default. 
We'll see how to make it dull and shadowed. 
...
It is shiny. That's because of the default lighting used by **rgl**. 
To get a dull and shadowed mesh, one has first to destroy these lights, and 
